...
! function (e) {
    ...
    i.prototype = {
        ...
        htmlInput: function () {
            return this.options.input ? '<input type="text" class="form-control upload-control text-truncate' + ("nr" == this.options.size ? "" : "form-control-" + this.options.size) + '" placeholder="' + this.options.placeholder + '" disabled> ' : ""
        },
    ...
    e.fn.filestyle = function (t, n) {
        ...
        text: "Upload",
        htmlIcon: "",
        btnClass: "btn-primary rounded-pill mr-2",
        size: "nr",
        input: !0,
        badge: !1,
